...
print("Processing...")
#Usage：“数据集路径”“inputlist文件名”“ outputprefix文件名”，"起始video序号" ,"结束video序号" ，“帧采样间隔”
#Example：create_inputlist_ouputprefix("/home/wjj/HDD/HDD/dataset_pytest/","input_list.txt","output_list_prefix.txt",1,13,16)
create_inputlist_ouputprefix("/samba/HDD/dataset_20170117_error/","input_list_ori.txt","output_list_prefix_ori.txt",1,45,16)
print("Done!")
