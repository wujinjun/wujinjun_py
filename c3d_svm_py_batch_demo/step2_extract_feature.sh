...
sh ./mkdir.sh
rm mkdir.sh
GLOG_logtosterr=1 /home/wjj/C3D/build/tools/extract_image_features.bin prototxt/c3d_feature_extractor_frm.prototxt _iter_6000 0 50 164 ./output_list_prefix_ori.txt fc6-1 
